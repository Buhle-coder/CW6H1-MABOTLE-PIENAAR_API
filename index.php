                ...
                <div class="col-1">
                    <div class="flex item justify-content-between">
                        <div class="flex">
                            ...
                            <div class="title">
                                <h3>Neverfull MM Monogram Camvas</h3>
                                <span>Handbag|LOUIS VUITTON</span>
                    ...
                    <div class="subtotal text-center">
                        ...
                        <ul>
                            <li class="flex justify-content-between">
                                <label for="price">Products ( 3 items ) :20%OFF </label>
                                
                                <span>R1899.99 each</span>
                            </li>
                            <li class="flex justify-content-between">
                            ...
                            <li class="flex justify-content-between">
                                ...
                                <span class="text-red font-title">R4557.60</span>
                            </li>
                        </ul>
